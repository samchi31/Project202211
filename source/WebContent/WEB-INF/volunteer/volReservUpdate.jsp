...
%>
		...
		<div id="button" style="text-align: right;">
			<p>
				<button type="submit" class="btn btn-success btn-lg" formaction="/volReservUpdate.do?reservId=<%=(rv.getReservId())%>" formmethod="post"  style="width: 240px;">등록</button>
				<button type="submit" class="btn btn-danger btn-lg" formaction="/myVolReserv.do" formmethod="get"  style="width: 240px;">취소</button>
			</p>
		</div>
     </form>
    </div><!-- container End -->
