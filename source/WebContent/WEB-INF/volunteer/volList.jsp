...
#v_status {font-family:'GmarketSansMedium', sans-serif ;position:absolute;top:93%;right:5%; 
font-weight:bold;font-size:20px;color:#444;}
#heart { background:#fff; border:0px solid #fff; position:relative; top: 10px;right:-42%}
...
<body>
   ...
   <div class="col-sm-12 text-center">
      ...
      <div class="container">
		...
		<div class="row col-sm-7 center" style="height: 130px; margin:20px; padding:2%">      
        	<h4 id="filter">
            <img src="https://cdn-icons-png.flaticon.com/512/107/107799.png">필터 적용
         	</h4>
	         <select class="form-control col-sm-2" name="location" style="width: 135px;white-space:nowrap; margin-right: 5px;"> 
	         ...
	         <select class="form-control col-sm-2" name="status" style="width: 135px;white-space:nowrap; margin-right: 5px;">
	             <option value="전체">전체</option>
	         ...
	         <select class="form-control col-sm-2" name="category" style="width: 135px; margin-right: 5px;">
	             <option value="전체">전체</option>
              ...
              <input class="form-control col-sm-2" id="textSearch" type="date" placeholder="날짜" value="" style="width: 135px;white-space:nowrap;">
       
              <button id="btn_search" class="btn isbox"><span class="glyphicon glyphicon-search"></span></button>
             
      </div>
         
        <div class="row col-sm-3" style="height: 130px;margin:20px;padding:2%;">
         <%if(isIns > 0){ %>
         	<div class="register">	
         		기관 회원 전용
            	<a href="volRegister.do" class="btn btn-info btn-lg" role="button" style="margin: 30px; margin-top: 10px;">봉사 프로그램 등록</a>
       		</div>
         <%} %>
      	</div>
      	<div class="col-sm-1"></div>
